    ...
    return (
        <div>
            ...
            <div className="hero-content flex-col justify-around lg:flex-row-reverse gap-10 ">
                ...
                <h3 className="text-2xl font-semibold text-[#FFD700] my-5 italic">About us</h3>
                <h3 className="text-4xl font-semibold text-[#FFD700] my-5 italic">Why Choose us?</h3>
                    ...
                    <h3 className="text-xl font-semibold text-[#FFD700] my-5 italic">Our special dish for you...</h3>
                    <ul className="space-y-2">
                        <li className="text-[#392623] text-base font-medium flex flex-row"><span className="text-3xl text-[#FFD700] pr-2"><BsCheckAll></BsCheckAll></span><span>Turmeric coconut rice, chicken sate with peanut sauce</span></li>
                        <li className="text-[#392623] text-base font-medium flex flex-row"><span className="text-3xl text-[#FFD700] pr-2"><BsCheckAll></BsCheckAll></span><span>Turmeric coconut rice, chicken sate with peanut sauce</span></li>
                        <li className="text-[#392623] text-base font-medium flex flex-row"><span className="text-3xl text-[#FFD700] pr-2"><BsCheckAll></BsCheckAll></span><span>Turmeric coconut rice, chicken sate with peanut sauce</span></li>
                    </ul>
                    <button className="text-xl pl-8 italic underline text-[#FFD700] font-semibold mt-3">Read More</button>
                </div>
