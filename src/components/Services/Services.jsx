...
const Services = () => {
    return (
        ...
        <div className="font-lato">
            ...
            <h3 className="text-4xl font-semibold text-[#2f2626] my-5 italic">Why we are the best</h3>
            ...
            <div className="bg-base-400 gap-5 rounded p-5">
                <div className='flex flex-row justify-left items-center '>
                    ...
                    <h3 className="font-semibold text-[#2f2626] text-2xl pl-5">Prickly Pear Tonic</h3>
                </div>
                <div className="text-left py-3">
                    <p className="text-lg text-[#3e3e3e] leading-8">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                        Quae molestias dolor consequatur
                        dolorem nemo cupiditate aperiam repellat ratione aliquam minus.</p>
                    <button className="text-xl italic underline text-[#894444] font-semibold">Read More</button>
                </div>
            </div>
            <div className="bg-base-400 gap-5 rounded p-5">
                <div className='flex flex-row justify-left items-center '>
