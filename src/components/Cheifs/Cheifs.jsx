...
const Cheifs = () => {
    return (
        <div className="font-lato ">
            ...
            <h3 className="text-4xl font-semibold text-[#2f2626] my-5 italic">They alawys try their best for your happiness</h3>

            <div className="mb-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 ">
                <div className="relative max-w-xs overflow-hidden bg-cover bg-no-repeat">
                    <img
                        src={chef1}
                        className="w-full h-96 border-[#2f2626] border-[2px]"
                        alt="Louvre" />
                    <div
                        ...
                        <div className="">
                            <h3 className="text-[#83837d] italic text-3xl font-bold">Alex Jone</h3>
                            <h3 className="text-[#894444] text-2xl font-medium">French Cusine</h3>
                            <p className="text-lg text-[#3e3e3e] leading-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic laboriosam a officiis.</p>
                ...
                <div className="relative max-w-xs overflow-hidden bg-cover bg-no-repeat">
                    ...
                    <div
                        className="absolute flex justify-center text-left p-10 bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-[#d0cfc9] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100">
                        <div className="">
                            <h3 className="text-[#83837d] italic text-3xl font-bold">Daniel Franky</h3>
                            <h3 className="text-[#894444] text-2xl font-medium">French Cusine</h3>
                            <p className="text-lg text-[#3e3e3e] leading-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic laboriosam a officiis.</p>
                            <div className="flex flex-row gap-5 pt-3">
                                <button className="text-4xl"><FaFacebook></FaFacebook></button>
                ...
                <div className="relative max-w-xs overflow-hidden bg-cover bg-no-repeat">
                    ...
                    <div
                        className="absolute flex justify-center text-left p-10 bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-[#d0cfc9] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100">
                        <div className="">
                            <h3 className="text-[#83837d] italic text-3xl font-bold">Tom Cook</h3>
                            <h3 className="text-[#894444] text-2xl font-medium">Cook</h3>
                            <p className="text-lg text-[#3e3e3e] leading-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic laboriosam a officiis.</p>
                            <div className="flex flex-row gap-5 pt-3">
                                <button className="text-4xl"><FaFacebook></FaFacebook></button>
                                <button className="text-4xl"><BsTwitter></BsTwitter></button>
                ...
                <div className="relative max-w-xs overflow-hidden bg-cover bg-no-repeat">
                    ...
                    <div
                        className="absolute flex justify-center text-left p-10 bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-[#d0cfc9] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100">
                        <div className="">
                            <h3 className="text-[#83837d] italic text-3xl font-bold">Michel Smart</h3>
                            <h3 className="text-[#894444] text-2xl font-medium">Cook</h3>
                            <p className="text-lg text-[#3e3e3e] leading-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic laboriosam a officiis.</p>
                            <div className="flex flex-row gap-5 pt-3">
                                <button className="text-4xl"><FaFacebook></FaFacebook></button>
