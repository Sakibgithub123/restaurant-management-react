        ...
        <div className="max-w-5xl mx-auto my-10 font-lato">
            <div className="flex flex-row rounded-lg">
                ...
                <div className="text-left pl-8 space-y-4">
                    <h3 className="text-xl text-[#FFD700] font-semibold">{food_name}</h3>
                    <h2 className="text-xl text-[#392623] font-semibold">Price : ${price}</h2>
                    <div className="flex flex-row gap-5">
                        <h2 className="text-base bg-[#52ea63] p-2 rounded-lg text-[#fff] font-semibold">{category}</h2>
                        <h2 className="text-base bg-[#52ea63] p-2 rounded-lg text-[#fff] font-semibold">{food_origin}</h2>
                    </div>
